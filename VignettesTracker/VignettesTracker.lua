...
{true,  6720, 42, 33940, 112187, 'Crag-Leaper\'s Cache', 42.7,31.7}, 
{true,  6720, 42, 33531, 112096, 'Clumsy Cragmaul Brute', 50.2,18.7}, --also fallen ogre
...
{true,  6720, 42, 34841, -824, 'Forgotten Supplies', 43.7,55.6},
{true,  6720, 42, 34968, -824, 'Forgotten Supplies', 43.7,55.6},
{true,  6720, 42, 34507, 110689, 'Frozen Frostwolf Axe', 24.2,48.6},
{true,  6720, 42, 33948, 111543, 'Goren Leftovers', 66.7,26.4},
{true,  6720, 42, 33947, -824, 'Grimfrost Treasure', 68.1,45.9},
{true,  6720, 42, 33017, -824, 'Iron Horde Supplies', 68.9,69.1},
...
{true,  6720, 42, 33502, 112087, 'Obsidian Petroglyph', 38.3,37.8}, --Carved Obsidian Idol
{true,  6720, 42, 34931, -824, 'Pale Loot Sack', 21.7,50.8},
{true,  6720, 42, 34967, -824, 'Raided Loot', 37.3,59.2},
...
{true,  6720, 42, 33500, 43696, 'Slave\'s Stash', 27.7,42.8}, --or 28.1,44.6?
...
{true,  6720, 42, 33942, -824, 'Supply Dump', 16.1,49.7},
{true,  6720, 42, 33946, -824, 'Survivalist\'s Cache', 64.7,25.7},
...
{true,  6720, 43, 34130, -824, 'Giantstalker Hunting Party', 58.6,31.9},
...
{false, 6719, 42, 33885, 0, 'Cargo of the Raven Queen', 84.6,44.8},
{false, 6719, 42, 33569, 113545, 'Carved Dinking Horn', 33.5,39.6},
{true,  6719, 42, 33575, 108904, 'Demonic Cache', 20.4,30.6},
...
{true,  6719, 42, 37254, 107457, 'Mushroom Covered Chest',52.9,24.9}, --Treasure Placeholder
...
{false, 6719, 42, 33565, 0, 'Scaly Rylak Egg', 67.0,84.2},
{true,  6719, 42, 33570, 113388, 'Shadowmoon Exile Treasure', 45.8,24.6},
{true,  6719, 42, 33571, 113563, 'Shadowmoon Sacrifical Dagger', 30.0,45.4},
{true,  6719, 42, 33571, -824, 'Shadowmoon Treasure', 28.2,39.3},
{false, 6719, 42, 35289, -824, 'Spark\'s Stolen Supplies', 30.9,12.8},
{false, 6719, 42, 35280, -824, 'Stolen Treasure', 27.1,2.5},
{true,  6719, 42, 35600, 118104, 'Strange Spore', 55.8,20.0},
{false, 6719, 42, 35677, 110506, 'Sunken Fishing Boat', 37.2,26.0},
{false, 6719, 42, 35279, -824, 'Sunken Treasure', 28.8,7.2},
{true,  6719, 42, 35580, 117550, 'Swamplighter Hive', 55.3,74.9},
{false, 6719, 42, 33540, 113546, 'Uzko\'s Knickknacks', 35.9,40.9},
{false, 6719, 42, 33866, 109124, 'Veema\'s Herb Bag', 34.2,43.5},
{true,  6719, 42, 33574, 113375, 'Vindicator\'s Cache', 51.1,79.1},
{true,  6719, 42, 33566, 113372, 'Waterlogged Chest', 39.2,83.9},
...
{false, 6721, 42, 36003, -824, 'mill: Aged Stone Container', 42.3,54.8},
{false, 6721, 42, 35701, -824, 'Mill: Ancient Titan Chest', 53.3,46.8},
{false, 6721, 42, 35984, -824, 'mill: Ancient Titan Chest', 50.2,53.8},
{false, 6721, 42, 36720, -824, 'mill: Ancient Titan Chest', 42.1,46.1},
...
{false, 6721, 42, 36716, -824, 'mill: Forgotten Skull Cache', 39.3,56.3},
...
{false, 6721, 42, 35980, -824, 'mill: Mysterious Petrified Pod', 41.1,77.3},
...
{false, 6721, 42, 36713, -824, 'Mill: Unknown Petrified Egg', 53.0,79.1},
{false, 6721, 42, 36718, -824, 'mill: Unknown Petrified Egg', 47.2,51.8},
...
{true,  6662, 42, 34260, 109118, 'Aruuna Mining Cart', 81.8,34.9},
{true,  6662, 42, 34252, -824, 'Barrel of Fish', 62.4,48.0},
{true,  6662, 42, 34259, 107457, 'Bonechewer Remnants', 33.3,76.8},
{false, 6662, 42, 34471, 0, 'Bright Coin', 73.5,51.4},
{true,  6662, 42, 34248, 116116, 'Charred Sword', 77.0,49.9}, 
{true,  6662, 42, 34239, 117569, 'Curious Deathweb Egg', 66.5,86.9},
...
{true,  6662, 42, 34253, 116118, 'Draenei Weapons', 55.3,66.7},
{true,  6662, 42, 34249, -824, 'Farmer\'s Bounty', 35.4,96.6},
{false, 6662, 42, 34238, 0, 'Foreman\'s Lunchbox', 57.4,28.7},
{true,  6662, 42, 36829, 107457, 'Gift of the Ancients', 28.4,74.2},
{true,  6662, 42, 34251, 117571, 'Iron Box', 64.6,79.2},
{true,  6662, 42, 33649, -824, 'Iron Scout', 75.1,36.1},
{true,  6662, 42, 34233, 117568, 'Jug of Aged Ironwine', 65.5,11.4},
{true,  6662, 42, 34261, -824, 'Keluu\'s Belongings', 75.7,41.4},
{true,  6662, 42, 34290, 116402, 'Ketya\'s Stash', 54.0,27.7},
{true,  6662, 42, 35964, 109192, 'Lightbearer (Aruumel\'s Mace)', 68.8,56.2},
{true,  6662, 42, 34101, 109192, 'Lightbearer (Aruumel\'s Worn Mace)', 68.8,56.2},
{true,  6662, 42, 34258, 107457, 'Light of the Sea', 38.2,12.4},
{true,  6662, 42, 34235, 116132, 'Luminous Shell', 52.6,29.5},
...
{true,  6662, 42, 34256, 116128, 'Relic of Telmor', 47.0,91.7},
{true,  6662, 42, 34232, 116117, 'Rook\'s Tacklebox', 64.9,13.3},
{false, 6662, 42, 34276, 0, 'Rusted Lockbox', 66.0,85.1},
{true,  6662, 42, 34254, 117570, 'Soulbinder\'s Reliquary', 39.5,55.1},
{true,  6662, 42, 35162, 112699, 'Teroclaw Nest', },
{true,  6662, 42, 34257, 116119, 'Treasure of Ango\'rosh', 38.3,84.5},
{true,  6662, 42, 34255, 116129, 'Webbed Sac', 65.4,88.6}, 
...
{false, 6662, 43, 34171, 116126, 'Taladorantula', }, --kill children to get her to spawn
...
{true,  6662, 43, 34204, 112261, 'Wandering Vindicator - kill', 69.4,33.2},
{true,  6662, 43, 34205, 112261, 'Wandering Vindicator - loot', 69.4,33.2},
...
{true,  6662, 44, 34115, 0, 'Four Friends found Horde', },
{false, 6662, 44, 34110, 0, 'Girl 1 found A', },
{true,  6662, 44, 34116, 0, 'Norana Quelldawn', },
{false, 6662, 44, 34111, 0, 'Girl 2 found A', },
{true,  6662, 44, 34117, 0, 'Riasa Songbrook', },
{false, 6662, 44, 34112, 0, 'Guy 1 found A', },
{true,  6662, 44, 34118, 0, 'Baran Silverblade', },
{false, 6662, 44, 34113, 0, 'Guy 2 found A', },
{true,  6662, 44, 34119, 0, 'Orian Sylvanleaf', },
...
{true,  6722, 42, 36453, 115463, 'Coinbender\'s Payment', 68.4,89.0},
{false, 6722, 42, 36459, 0, 'Dislodged Saw Blade', 43.8,61.6},
{false, 6722, 42, 36454, 107457, 'Drypeak Mushrooms', 63.6,67.4},
{true,  6722, 42, 36395, 115463, 'Elixir of Shadow Sight, Skettis', 43.9,15.0},
{true,  6722, 42, 36397, 115463, 'Elixir of Shadow Sight, Veil Akraz', 43.8,24.6},
{true,  6722, 42, 36398, 115463, 'Elixir of Shadow Sight, Sethekk Hollow', 69.2,43.3},
{true,  6722, 42, 36399, 115463, 'Elixir of Shadow Sight, Bloodmane Valley', 49.1,62.6},
{true,  6722, 42, 36400, 115463, 'Elixir of Shadow Sight, Shadow\'s Vigil', 55.6,22.1},
{true,  6722, 42, 36401, 115463, 'Elixir of Shadow Sight, Bloodmane Pridelands', 53.1,84.5},
...
{true,  6722, 42, 36381, 118240, 'Gift of Anzu, Sword Str/Agi', 61.1,55.4},
{true,  6722, 42, 36386, 118237, 'Gift of Anzu, Crossbow', 48.6,44.5},
{true,  6722, 42, 36388, 118242, 'Gift of Anzu, Wand', 42.4,26.7},
{true,  6722, 42, 36389, 118238, 'Gift of Anzu, Polearm', 46.9,40.5},
{true,  6722, 42, 36390, 118241, 'Gift of Anzu, Sword Int', 57.0,78.9},
{true,  6722, 42, 36392, 118239, 'Gift of Anzu, Staff', 52.0,19.6},
...
{true,  6722, 42, 36406, 118267, 'Offering to the Raven Mother, Bloodmane Valley North', 48.9,54.7},
...
{true,  6722, 42, 36340, {116921, 116922}, 'Ogron Plunder', 58.7,60.2},
{true,  6722, 42, 36402, 107457, 'Orcish Signaling Horn', 36.3,39.3},
...
{true,  6722, 42, 36450, {117437, 109223}, 'Sethekk Ritual Brew', 71.6,48.6},
...
{true,  6722, 44, 35334, 118207, 'The Egg of Varasha', 29.6,41.6},
...
{false, 1, 43, 37355, -823, 'Lady Temptessa', },
