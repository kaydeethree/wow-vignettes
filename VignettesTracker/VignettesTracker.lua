...
local function go(zone)
 ...
 for i=1,#vignettes do
  if not vignettes[i][1] and (zone == -1 or vignettes[i][2] == zone)
   ...
   t = vignettes[i]
   myChatFrame:AddMessage(vignetteType[t[3]].. ' '.. t[4]..' '..t[5]..
     ' @'..zones[t[2]]..':'..(t[6] or '?')..','..(t[7] or '?'));
  end
 end
end
...
{true,  6720, 42, 33916, 'Arena Master\'s War Horn', 23.2,25.0},
{true,  6720, 42, 34520, 'Burning Pearl', 42.4,19.6},
{true,  6720, 42, 33940, 'Crag-Leaper\'s Cache', 42.7,31.8},
{true,  6720, 42, 33531, 'Clumsy Cragmaul Brute', 50.2,18.7},
{true,  6720, 42, 34473, 'Envoy\'s Satchel', 40.9,20.1},
{true,  6720, 42, 34841, 'Forgotten Supplies', 43.7,55.6},
{true,  6720, 42, 34968, 'Forgotten Supplies', 43.7,55.6},
{true,  6720, 42, 34507, 'Frozen Frostwolf Axe', 24.2,48.6},
{true,  6720, 42, 33948, 'Goren Leftovers', 66.7,26.4},
{true,  6720, 42, 33947, 'Grimfrost Treasure', 68.1,45.9},
{true,  6720, 42, 33017, 'Iron Horde Supplies', 68.9,69.1},
{false, 6720, 42, 34937, 'Lady Sena\'s Other Materials Stash', 51.4,66.8},
{true,  6720, 42, 33926, 'Lagoon Pool', 21.7,9.6},
{true,  6720, 42, 34642, 'Lucky Coin', 19.2,12.0},
{true,  6720, 42, 33961, 'Mysterious Flower, Frostfire Ridge', 71.6,69.6},
{true,  6720, 42, 33502, 'Obsidian Petroglyph', 38.3,37.8},
{true,  6720, 42, 34931, 'Pale Loot Sack', 21.7,50.8},
{true,  6720, 42, 34967, 'Raided Loot', 37.3,59.2},
{true,  6720, 42, 34641, 'Sealed Jug', 9.8,45.3},
{false, 6720, 42, 33977, 'Shamanstone, Blessing of the Wolf', 27.1,36.5},
{true,  6720, 42, 33979, 'Shamanstone, Buffeting Galefury', 65.2,79.1},
{false, 6720, 42, 33980, 'Shamanstone, Ogrish Fortitude', 43.9,12.3},
{true,  6720, 42, 33978, 'Shamanstone, Spirit of the Wolf', 17.5,56.7},
{true,  6720, 42, 33981, 'Shamanstone, Touched by Fire', 37.0,33.2},
{true,  6720, 42, 33982, 'Shamanstone, Touched by Ice', 60.4,13.7},
{true,  6720, 42, 33500, 'Slave\'s Stash', 27.7,42.8},
{false, 6720, 42, 34649, 'Smoldering True Iron Deposit', 36.3,32.3},
{true,  6720, 42, 33501, 'Spectator\'s Chest', 24.2,27.1},
{true,  6720, 42, 33942, 'Supply Dump', 16.1,49.7},
{true,  6720, 42, 33946, 'Survivalist\'s Cache', 64.7,25.7},
{true,  6720, 42, 32803, 'Thunderlord Cache', 34.2,23.5},
{true,  6720, 42, 33440, 'Time-Warped Bladespire Brute, Falling Lower', 30.5,50.8},
{true,  6720, 42, 33497, 'Time-Warped Bladespire Brute, Falling Higher', 30.5,50.9},
{true,  6720, 42, 33439, 'Time-Warped Bladespire Brute, Running', 30.3,50.6},
{true,  6720, 42, 33438, 'Time-Warped Bladespire Primalist', 30.3,51.2},
{true,  6720, 42, 33505, 'Wiggling Egg', 64.4,65.8},
{true,  6720, 42, 33525, 'Young Orc Traveler', 54.8,35.5},
{true,  6720, 42, 33525, 'Young Orc Woman', 63.4,14.7},

--Frostfire Ridge npcs
{true,  6720, 43, 34497, 'Breathless', 27.8,50.3},
{true,  6720, 43, 32941, 'Canyon Icemother', 33.5,23.1},
{true,  6720, 43, 34843, 'Chillfang', 41.4,68.3},
{false, 6720, 43, 33014, 'Cindermaw', 40.6,47.1},
{true,  6720, 43, 34129, 'Coldstomp the Griever', 25.9,55.2},
{false, 6720, 43, 34131, 'Coldtusk', 54.2,67.7},
{true,  6720, 43, 34477, 'Cyclonic Fury', 67,78},
{false, 6720, 43, 34130, 'Giantstalker Hunting Party', 58,32},
{true,  6720, 43, 34132, 'Scout Goreseeker', 76.5,63.5},
{true,  6720, 43, 33512, 'Gorg\'ak the Lava Guzzler', 72.5,22.8},
{true,  6720, 43, 34865, 'Grutush the Pillager', 38.6,62.9},
{false, 6720, 43, 34825, 'Gruuk', 51.8,65.1},
{true,  6720, 43, 34839, 'Gurun', 47.1,55.2},
{true,  6720, 43, 34708, 'Jehil the Climber', 61.8,26.6},
{true,  6720, 43, 32918, 'Giant-Slayer Kul', 54.7,22.3},
{true,  6720, 43, 33938, 'Primalist Mur\'og', 37.0,33.8},
{true,  6720, 43, 34470, 'Pale Fishmonger', 28.3,66.6},
{true,  6720, 43, 33843, 'Broodmother Reeg\'ak', 65.6,31.4},
{true,  6720, 43, 34133, 'The Beater', 26.9,31.9},
{false, 6720, 43, 34361, 'The Bone Crawler', 70,30},
{true,  6720, 43, 34559, 'Yaga the Scarred', 40.6,27.6},

-- Frostfire Ridge events
{true,  6720, 44, 34476, 'Frozen Treasure', 57.2,52.1},
{true,  6720, 44, 33504, 'Firefury Stone and Firefury Giant', 71.7,47.0},
...
--Talador objects
{true,  6662, 42, 34236, 'Amethyl Crystal', 62.1,32.4},
{true,  6662, 42, 34259, 'Bonechewer Remnants', 33.3,76.8},
{true,  6662, 42, 33931, 'Deceptia getting blown up', 58.8,12.1},
{true,  6662, 42, 33933, 'Deceptia\'s Smoldering Boots', 58.1,12.1},
{true,  6662, 42, 34249, 'Farmer\'s Bounty', 35.4,96.6},
{true,  6662, 42, 36829, 'Gift of the Ancients', 28.4,74.2},
{true,  6662, 42, 34251, 'Iron Box', 64.6,79.2},
{true,  6662, 42, 34233, 'Jug of Aged Ironwine', 65.5,11.4},
{true,  6662, 42, 34290, 'Ketya\'s Stash', 54.0,27.7},
{true,  6662, 42, 33960, 'Mysterious Flower, Talador', 50.7,30.0},
{true,  6662, 42, 34263, 'Pure Crystal Dust', 78.2,14.7},
{true,  6662, 42, 34250, 'Relic of Aruuna', 75.8,44.7},
{true,  6662, 42, 34254, 'Soulbinder\'s Reliquary', 39.5,55.1},
{true,  6662, 42, 34255, 'Webbed Sac', 65.4,88.6},

--Talador NPCs
{true,  6662, 43, 34668, 'Burning Front rare demon', 56.7,62.5},
{true,  6662, 43, 35018, 'Felbark', 50.4,83.5},
{true,  6662, 43, 34165, 'Cro Fleshrender', 37.4,70.4},
{true,  6662, 43, 34145, 'Frenzied Golem', 46.4,54.8}, 
{true,  6662, 43, 34929, 'Gennadian', 67.5,80.8},
{true,  6662, 43, 34189, 'Glimmerwing', 32.7,63.2},
{true,  6662, 43, 34142, 'Dr. Gloom', 68.4,15.7},
{true,  6662, 42, 36919, 'A Restless Crate and Grrbrrgle', 22.2,74.2},
{true,  6662, 43, 34185, 'Hammertooth', 62.6,45.4},
{true,  6662, 43, 34167, 'Hen-Mother Hami', 76.3,52.2},
{true,  6662, 43, 34208, 'Lo\'marg Jawcrusher', 49.2,92.3},
{true,  6662, 43, 34498, 'Klikixx', 66.8,85.3},
{true,  6662, 43, 34859, 'No\'losh', 86.4,30.9},
{true,  6662, 43, 34196, 'Ra\'kahn', 59.5,60.0, },
{true,  6662, 43, 34671, 'Shirzir', 43.0,54.1},
{true,  6662, 43, 36858, 'Steeltusk', 67.7,35.8},
{true,  6662, 43, 34945, 'Underseer Bloodmane', 63.8,20.7},
{true,  6662, 43, 35491, 'Underseer Bloodmane', 63.8,20.7},
{true,  6662, 43, 34148, 'Viperlash', 37.6,74.9},
{false, 6662, 43, 34204, 'Wandering Vindicator - kill', 69.4,33.2},
{false, 6662, 43, 34205, 'Wandering Vindicator - loot', 69.4,33.2},
{true,  6662, 43, 34135, 'Yazheera the Incinerator', 53.8,25.6},
...
{true,  6722, 43, 36943, 'Gaze', 24.9,25.6},
...
{false, 1, 42, 32913, 'Arranok\'s Ritual', },
{false, 1, 42, 35964, 'Aruumel\'s Mace', },
{false, 1, 42, 34101, 'Aruumel\'s Worn Mace', },
{false, 1, 42, 34260, 'Aruuna Mining Cart A', },
{false, 1, 42, 36262, 'Aruuna Mining Cart B', },
{false, 1, 42, 34252, 'Barrel of Fish'},
{false, 1, 42, 36937, 'Bladefury Treasure - Burning Blade Cache', },
{false, 1, 42, 33498, 'Bladespire Chef', },
{false, 1, 42, 33447, 'Bladespire Craftsman', },
{false, 1, 42, 33989, 'Blasting Charges - Cave A Cache', },
{false, 1, 42, 33991, 'Blasting Charges - Cave B Cache', },
{false, 1, 42, 33996, 'Blasting Charges - Cave C Cache', },
{false, 1, 42, 33998, 'Blasting Charges - Cave D Cache', },
{false, 1, 42, 33975, 'Blasting Charges - Rubble A', },
{false, 1, 42, 33990, 'Blasting Charges - Rubble B', },
{false, 1, 42, 33995, 'Blasting Charges - Rubble C', },
{false, 1, 42, 33997, 'Blasting Charges - Rubble D', },
{false, 1, 42, 36658, 'Botani Stockpile', },
{false, 1, 42, 35219, 'Burning Front (unused?)', },
{false, 1, 42, 36849, 'Burning Missive A', },
{false, 1, 42, 36850, 'Burning Missive B', },
{false, 1, 42, 36851, 'Burning Missive C', },
{false, 1, 42, 36852, 'Burning Missive D', },
{false, 1, 42, 36853, 'Burning Missive E', },
{false, 1, 42, 36854, 'Burning Missive F', },
{false, 1, 42, 36855, 'Burning Missive G', },
{false, 1, 42, 36856, 'Burning Missive H', },
{false, 1, 42, 34471, 'Bright Coin', },
{false, 1, 42, 34248, 'Charred Sword', },
{false, 1, 42, 33565, 'Chimaera Scale', },
{false, 1, 42, 36453, 'Coinbender\'s Payment', },
{false, 1, 42, 36604, 'Dark Iron Emergency Pack', },
{false, 1, 42, 33575, 'Demonic Cache', },
{false, 1, 42, 36625, 'Discarded Pack', },
{false, 1, 42, 36459, 'Dislodged Saw Blade', },
...
{false, 1, 42, 37170, 'Femur of Improbability', },
{false, 1, 42, 34238, 'Foreman\'s Lunchbox', },
{false, 1, 42, 33925, 'Frostwolf Cache 01', },
{false, 1, 42, 33945, 'Frostwolf Cache 03', },
{false, 1, 42, 33949, 'Frostwolf Cache 07', },
{false, 1, 42, 33016, 'Frostwolf Supply Cache', },
{false, 1, 42, 35580, 'Giant Beehive', },
{false, 1, 42, 36381, 'Gift of Anzu', },
{false, 1, 42, 36386, 'Gift of Anzu (Crossbow)', },
{false, 1, 42, 36388, 'Gift of Anzu (Wand)', },
{false, 1, 42, 36389, 'Gift of Anzu (Mask)', },
{false, 1, 42, 36390, 'Gift of Anzu (Knife)', },
{false, 1, 42, 36392, 'Gift of Anzu (Axe)', },
{false, 1, 42, 35282, 'Glowing Blue Mushroom', },
{false, 1, 42, 34648, 'Gnawed Bone', },
{false, 1, 42, 36621, 'Gnome Canister', },
{false, 1, 42, 36834, 'Gorgrond Ogre Gateway', },
{false, 1, 42, 34713, 'Gronnstalker\'s Cache', },
...
{false, 1, 42, 34222, 'Iron Horde Blacksmith', },
{false, 1, 42, 34225, 'Iron Horde Slacker', },
{false, 1, 42, 34223, 'Iron Horde Stable Master', },
{false, 1, 42, 36596, 'Iron Horde Weapon Stash', },
{false, 1, 42, 36863, 'Iron Horde Munitions', },
{false, 1, 42, 34261, 'Keluu\'s Belongings', },
{false, 1, 42, 34907, 'Lagoon Pool/Giant Clam?', },
{false, 1, 42, 34936, 'Lady Sena\'s Extra Stash?', },
{false, 1, 42, 35709, 'Laughing Skull Cache', },
...
{false, 1, 42, 36405, 'Offering to the Raven Mother 02', },
{false, 1, 42, 35347, 'Ogre Booty 000', },
{false, 1, 42, 35367, 'Ogre Booty 001', },
{false, 1, 42, 35368, 'Ogre Booty 002', },
{false, 1, 42, 35369, 'Ogre Booty 003', },
{false, 1, 42, 35370, 'Ogre Booty 004', },
{false, 1, 42, 35371, 'Ogre Booty 005', },
{false, 1, 42, 35373, 'Ogre Booty 006', },
{false, 1, 42, 35567, 'Ogre Booty 007', },
{false, 1, 42, 35568, 'Ogre Booty 008', },
{false, 1, 42, 35569, 'Ogre Booty 009', },
{false, 1, 42, 35570, 'Ogre Booty 010', },
{false, 1, 42, 33532, 'Ogre Cache', },
...
{false, 1, 42, 36340, 'Ogron Plunder', },
{false, 1, 42, 36402, 'Orcish Signaling Horn', },
{false, 1, 42, 36506, 'Orc Super Caster Loot', },
{false, 1, 42, 36118, 'Pile of Rubble', },
{false, 1, 42, 36415, 'Reagent Pouch', },
{false, 1, 42, 34256, 'Relic of Telmor', },
{false, 1, 42, 36798, 'Rooby Roo', },
{false, 1, 42, 34232, 'Rook\'s Tacklebox', },
{false, 1, 42, 34276, 'Rusted Lockbox', },
{false, 1, 42, 36521, 'Rylak Egg', },
{false, 1, 42, 33930, 'Sabron Stash', },
{false, 1, 42, 35919, 'Sacrifice', },
{false, 1, 42, 36631, 'Sasha\'s Stash', },
{false, 1, 42, 34652, 'Savage Clam', },
{false, 1, 42, 36375, 'Sethekk Idol', },
{false, 1, 42, 36450, 'Sethekk Ritual Brew', },
{false, 1, 42, 33883, 'Shadowmoon Treasure #2', },
{false, 1, 42, 36651, 'SHarvest Crystal', },
{false, 1, 42, 36361, 'Shattered Hand Lockbox', },
{false, 1, 42, 36634, 'Sniper\'s Crossbow', },
{false, 1, 42, 34647, 'Snow-Covered Strongbox', },
{false, 1, 42, 34207, 'Sparkling Pool', },
{false, 1, 42, 36374, 'Statue of Anzu', },
{false, 1, 42, 35600, 'Strange Spore A', },
{false, 1, 42, 37249, 'Strange Spore B', },
{false, 1, 42, 36424, 'Sun-Touched Cache C', },
{false, 1, 42, 33965, 'Tanaan Flowerpicker', },
{false, 1, 42, 36463, 'Taylor\'s Coffer Key (unused?)', },
{false, 1, 42, 36878, 'The Light of Karabor', },
{false, 1, 42, 33499, 'Time-Warped Ogre', },
{false, 1, 42, 33649, 'Torched Iron Horde Scout', },
{false, 1, 42, 34557, 'Treasure Map A', },
{false, 1, 42, 36464, 'Treasure Mab B', },
{false, 1, 42, 36465, 'Treasure Map C', },
{false, 1, 42, 36466, 'Treasure Map D', },
{false, 1, 42, 36467, 'Treasure Map E', },
{false, 1, 42, 36468, 'Treasure Map F', },
{false, 1, 42, 34257, 'Treasure of Ango\'rosh', },
{false, 1, 42, 34239, 'Treasure of Tuurem', },
{false, 1, 42, 36053, 'Unused Wood Pile', },
{false, 1, 42, 33574, 'Vindicator\'s Cache', },
{false, 1, 42, 34760, 'Warchest of Kull\'krosh', },
{false, 1, 42, 34140, 'Yuuri\'s Gift', },

{false, 1, 43, 36902, 'Aeda Brightdawn', },
{false, 1, 43, 32911, 'Ancient Clefthoof', },
{false, 1, 43, 34191, 'Un\'glok Blackfinger', },
{false, 1, 43, 34197, 'Bloodbloom the Colossus', },
{false, 1, 43, 34224, 'Bloodcleave', },
{false, 1, 43, 34127, 'Mother Bloodtusk', },
{false, 1, 43, 34519, 'Brotoculus', },
{false, 1, 43, 32920, 'Deathtoll', },
{false, 1, 43, 35996, 'Depthroot', },
{false, 1, 43, 34382, 'Grand Warlock Duress', },
{false, 1, 43, 34517, 'Gargantuan Frostbeak', },
{false, 1, 43, 34483, 'Galzomar (unused?)', },
{false, 1, 43, 34231, 'Giant Snake', },
{false, 1, 43, 34412, 'Gnarljaw', },
{false, 1, 43, 34851, 'Gruuk?', },
{false, 1, 43, 37312, 'Haakun, The All-Consuming', },
{false, 1, 43, 34162, 'Icklarv', },
...
{false, 1, 43, 35220, 'Kharazos the Triumphant (unused?)', },
{false, 1, 43, 34411, 'King Slime', },
{false, 1, 43, 36936, 'Leorajh', },
{false, 1, 43, 34243, 'Rak\'nar Muzzlebash', },
{false, 1, 43, 34160, 'Nixxie the Goblin', },
{false, 1, 43, 34198, 'Roardan', },
{false, 1, 43, 33057, 'Rotbelcher', },
{false, 1, 43, 35244, 'Skagg', },
{false, 1, 43, 32921, 'Skel\'tik the Baleful', },
{false, 1, 43, 34168, 'Stormwave', },
{false, 1, 43, 34171, 'Taladorantula', },
{false, 1, 43, 36877, 'Torommok', },
{false, 1, 43, 34522, 'Ug\'lok the Frozen', },
{false, 1, 43, 36312, 'Sun Age Valarik', },
